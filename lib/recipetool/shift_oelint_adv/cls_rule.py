...
from shift_oelint_adv.rule_file import get_relpaths
from shift_oelint_adv.rule_file import get_rulefile
...
class Rule(object):
    ...
    def check(self, _file, stash):
        ...
        Arguments:
            ...
            stash {shift_oelint_adv.cls_stash.Stash} -- Parsed stash
    ...
    def is_lone_append(stash, file):
        ...
        Args:
            stash {shift_oelint_parser.cls_stash.Stash} -- Parsed stash
