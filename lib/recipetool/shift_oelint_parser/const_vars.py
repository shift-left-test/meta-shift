...
from shift_oelint_parser.constants import CONSTANTS, Constants

__warning_shown = False

if not __warning_shown:
    sys.stderr.write('{} is deprecated. Please use "from shift_oelint_parser.constants import CONSTANTS" instead\n'.format(__name__))
