...
from shift_oelint_parser.constants import CONSTANTS, Constants  # noqa: F401

__warning_shown = False

if not __warning_shown:
    sys.stderr.write(
        '{name} is deprecated. Please use "from shift_oelint_parser.constants import CONSTANTS" instead\n'.format(name=__name__))
