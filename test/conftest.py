...
def test_clang_build(request, tmpdir_factory):
    ...
    request.addfinalizer(cleanup)
    return BuildEnvironment(branch="zeus", conf_file="conf/test_clang.conf", repo_dir=repo_dir, build_dir=build_dir)
...
def report_clang_build(request, tmpdir_factory):
    ...
    request.addfinalizer(cleanup)
    return BuildEnvironment(branch="zeus", conf_file="conf/report_clang.conf", repo_dir=repo_dir, build_dir=build_dir)
...
def sdk_build(request, tmpdir_factory):
    ...
    request.addfinalizer(cleanup)
    return SdkBuildEnvironment(branch="zeus", conf_file="conf/bare.conf", repo_dir=repo_dir, build_dir=build_dir)
