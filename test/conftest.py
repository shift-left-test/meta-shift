...
def bare_build(request, tmpdir_factory):
    ...
    return BuildEnvironment(branch="honister", conf_file="conf/bare.conf", repo_dir=repo_dir, build_dir=build_dir)
...
def release_build(request, tmpdir_factory):
    ...
    request.addfinalizer(cleanup)
    return BuildEnvironment(branch="honister", conf_file="conf/release.conf", repo_dir=repo_dir, build_dir=build_dir)
...
def test_build(request, tmpdir_factory):
    ...
    request.addfinalizer(cleanup)
    return BuildEnvironment(branch="honister", conf_file="conf/test.conf", repo_dir=repo_dir, build_dir=build_dir)
...
def test_qt6_build(request, tmpdir_factory):
    ...
    request.addfinalizer(cleanup)
    return BuildEnvironment(branch="honister", conf_file="conf/test_qt6.conf", repo_dir=repo_dir, build_dir=build_dir)
...
def report_build(request, tmpdir_factory):
    ...
    request.addfinalizer(cleanup)
    return BuildEnvironment(branch="honister", conf_file="conf/report.conf", repo_dir=repo_dir, build_dir=build_dir)
...
def report_qt6_build(request, tmpdir_factory):
    ...
    request.addfinalizer(cleanup)
    return BuildEnvironment(branch="honister", conf_file="conf/report_qt6.conf", repo_dir=repo_dir, build_dir=build_dir)
...
def test_clang_build(request, tmpdir_factory):
    ...
    request.addfinalizer(cleanup)
    return BuildEnvironment(branch="honister", conf_file="conf/test_clang.conf", repo_dir=repo_dir, build_dir=build_dir)
...
def test_clang_qt6_build(request, tmpdir_factory):
    ...
    request.addfinalizer(cleanup)
    return BuildEnvironment(branch="honister", conf_file="conf/test_clang_qt6.conf", repo_dir=repo_dir, build_dir=build_dir)
...
def report_clang_build(request, tmpdir_factory):
    ...
    request.addfinalizer(cleanup)
    return BuildEnvironment(branch="honister", conf_file="conf/report_clang.conf", repo_dir=repo_dir, build_dir=build_dir)
...
def report_clang_qt6_build(request, tmpdir_factory):
    ...
    request.addfinalizer(cleanup)
    return BuildEnvironment(branch="honister", conf_file="conf/report_clang_qt6.conf", repo_dir=repo_dir, build_dir=build_dir)
...
def sdk_build(request, tmpdir_factory):
    ...
    request.addfinalizer(cleanup)
    return SdkBuildEnvironment(branch="honister", conf_file="conf/bare.conf", repo_dir=repo_dir, build_dir=build_dir)
