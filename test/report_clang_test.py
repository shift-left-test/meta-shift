...
def test_qmake_project_do_checkcodeall(report_clang_build):
    report_clang_build.files.remove("report")
    assert report_clang_build.shell.execute("bitbake qmake-project -c checkcodeall").stderr.empty()
    READ = report_clang_build.files.read
...
def test_qmake_project_do_checktestall(report_clang_build):
    report_clang_build.files.remove("report")
    assert report_clang_build.shell.execute("bitbake qmake-project -c checktestall").stderr.empty()
    READ = report_clang_build.files.read
...
def test_qmake_project_do_reportall(report_clang_build):
    report_clang_build.files.remove("report")

    assert report_clang_build.shell.execute("bitbake qmake-project -c reportall").stderr.empty()
