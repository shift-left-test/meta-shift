...
def test_cmake_project_do_checktest(shared_report_build):
    ...
    with shared_report_build.files.read("report/cmake-project-1.0.0-r0/checktest/index.html") as f:
...
def test_qmake_project_do_checktest(shared_report_build):
    ...
    with shared_report_build.files.read("report/qmake-project-1.0.0-r0/checktest/index.html") as f:
        assert f.contains(SENTINEL_HTML_TITLE)
...
def test_autotools_project_do_checktest(shared_report_build):
    ...
    with shared_report_build.files.read("report/autotools-project-1.0.0-r0/checktest/index.html") as f:
        assert f.contains(SENTINEL_HTML_TITLE)
