...
def test_cmake_project_do_checktest(shared_report_build):
    mutations = shared_report_build.files.asXml("report/cmake-project-1.0.0-r0/checktest/mutations.xml")
    assert mutations.containsElement("mutations")

    index = shared_report_build.files.asHtml("report/cmake-project-1.0.0-r0/checktest/index.html")
    assert index.containsElementWithText("h1", SENTINEL_HTML_TITLE)
...
def test_qmake_project_do_test(shared_report_build):
    ...
    assert test2.containsElementWithAttrib("testcase", {"classname":"PlusTest"})
    ...
    assert test3.containsElementWithAttrib("testcase", {"classname":"MinusTest"})
...
def test_qmake_project_do_checktest(shared_report_build):
    mutations = shared_report_build.files.asXml("report/qmake-project-1.0.0-r0/checktest/mutations.xml")
    assert mutations.containsElement("mutations")

    index = shared_report_build.files.asHtml("report/qmake-project-1.0.0-r0/checktest/index.html")
    assert index.containsElementWithText("h1", SENTINEL_HTML_TITLE)
...
def test_autotools_project_do_checktest(shared_report_build):
    mutations = shared_report_build.files.asXml("report/autotools-project-1.0.0-r0/checktest/mutations.xml")
    assert mutations.containsElement("mutations")

    index = shared_report_build.files.asHtml("report/autotools-project-1.0.0-r0/checktest/index.html")
    assert index.containsElementWithText("h1", SENTINEL_HTML_TITLE)
