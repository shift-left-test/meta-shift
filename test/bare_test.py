...
def test_core_image_minimal_populate_sdk(bare_build):
    ...
    assert pkgs.contains("nativesdk-cmake_3.6.1-r0_x86_64-nativesdk.ipk")
    ...
    assert pkgs.contains("nativesdk-qemu_2.7.0-r1_x86_64-nativesdk.ipk")
    ...
    assert pkgs.contains("gtest_1.7.0-r0_aarch64.ipk")
    ...
    installer = os.path.join(bare_build.build_dir, "tmp", "deploy", "sdk", "poky-glibc-x86_64-core-image-minimal-aarch64-toolchain-2.2.4.sh")
...
def test_cmakeutils_nativesdk(bare_build):
    ...
    f = "tmp/work/x86_64-nativesdk-pokysdk-linux/nativesdk-cmake/3.6.1-r0/sysroot-destdir/" \
        "opt/poky/2.2.4/sysroots/x86_64-pokysdk-linux/usr/share/cmake/OEToolchainConfig.cmake.d/crosscompiling_emulator.cmake"
