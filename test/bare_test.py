...
def test_core_image_minimal_populate_sdk(bare_build):
    ...
    installer = os.path.join(bare_build.build_dir, "tmp", "deploy", "sdk", "poky-glibc-x86_64-core-image-minimal-aarch64-toolchain-2.3.4.sh")
...
def test_cmakeutils_nativesdk(bare_build):
    ...
    f = "tmp/work/x86_64-nativesdk-pokysdk-linux/nativesdk-cmake/3.7.2-r0/sysroot-destdir/" \
        "opt/poky/2.3.4/sysroots/x86_64-pokysdk-linux/usr/share/cmake/OEToolchainConfig.cmake.d/crosscompiling_emulator.cmake"
