...
class core_image_minimal(unittest.TestCase):
    ...
    def test_do_coverageall(self):
        ...
        assert self.build.files.read("report/test_result/humidifier-project-1.0.0-r0/unittest.xml").contains('classname="humidifier-project.HumidifierTest"')
        ...
        assert self.build.files.read("report/test_coverage/humidifier-project-1.0.0-r0/coverage.xml").contains('name="humidifier-project.humidifier.src"')

    def test_do_coverageall_demangle(self):
        assert self.build.shell.execute("bitbake core-image-minimal -c coverageall").stderr.empty()
        assert self.build.files.read("report/test_coverage/cmake-project-1.0.0-r0/coverage.xml").containsAll(
        ...
        assert self.build.files.read("report/test_coverage/sqlite3wrapper-0.1.0-r0/coverage.xml").containsAll(
        ...
        assert self.build.files.read("report/test_coverage/stringutils-0.0.1-r0/coverage.xml").containsAll(
            '<method branch-rate="1.0" line-rate="1.0" name="bool util::string::contains&lt;char&gt;(char const*, char const*)" signature="">')
        assert self.build.files.read("report/test_coverage/qmake5-project-1.0.0-r0/coverage.xml").containsAll(
            '<method branch-rate="1.0" line-rate="1.0" name="arithmetic::plus(int, int)" signature="">',
            '<method branch-rate="1.0" line-rate="1.0" name="arithmetic::minus(int, int)" signature="">')
        assert self.build.files.read("report/test_coverage/autotools-project-1.0.0-r0/coverage.xml").containsAll(
            '<method branch-rate="1.0" line-rate="1.0" name="arithmetic::plus(int, int)" signature="">',
            '<method branch-rate="1.0" line-rate="1.0" name="arithmetic::minus(int, int)" signature="">')
        assert self.build.files.read("report/test_coverage/humidifier-project-1.0.0-r0/coverage.xml").containsAll(
...
class qmake5_project5(unittest.TestCase):
    ...
    def test_do_coverage_demangle(self):
        assert self.build.shell.execute("bitbake qmake5-project -c coverageall").stderr.empty()
        assert self.build.files.read("report/test_coverage/qmake5-project-1.0.0-r0/coverage.xml").containsAll(
            '<method branch-rate="1.0" line-rate="1.0" name="arithmetic::plus(int, int)" signature="">',
            '<method branch-rate="1.0" line-rate="1.0" name="arithmetic::minus(int, int)" signature="">')
